<!DOCTYPE html>
    ...
    <link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/scss/style.css">
    <link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/css/menu.css">
    <link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/animate/animate.css">
    <script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/jquery3.5.1.min.js"></script>
